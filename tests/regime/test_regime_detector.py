...
from crypto_strategy_lab.config import RegimeConfig
from crypto_strategy_lab.indicators.registry import warmup_bars
...
def test_priority_order_is_documented() -> None:
    from crypto_strategy_lab.regime.models import REGIME_PRIORITY, Regime
